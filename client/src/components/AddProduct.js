...
function AddProduct(props) {
  ...
  useEffect(() => {
    ...
    if (imagesUpload.length > 0 && product != null && sentinal == 0) {
      imagesUpload.map((image) => {
        ...
        const imageRef = ref(
          storage,
          `products/${product.product_id}/${image.id}.png`
        );
  ...
  return (
    <>
      ...
      <div className="box-border relative shrink-0 mx-auto mt-5 mb-36 h-auto">
        <section
          className="box-border flex relative flex-col grow shrink-0 self-stretch p-5 mx-auto w-full max-w-[1200px] min-h-[100px]"
        ...
        >
          <Form onSubmit={handleOnSubmit}>
            ...
            <div className="mt-2.5">
              <label htmlFor="product_available_start_time">
                <br></br>
              </label>
              <FormInput
                type="text"
                ...
                onChange={(e) =>
                  setproduct_available_start_time(e.target.value)
                }
            ...
            <div className="mt-2.5">
              <label htmlFor="product_available_end_time">
                <br></br>
              </label>
              <FormInput
                type="text"
            ...
            <br></br>
            <br></br>
            <Button className="mt-5 rounded-lg bg-blue-500 text-white px-5 py-2 hover:bg-blue-600">
              Submit
            </Button>
          </Form>
        </section>
